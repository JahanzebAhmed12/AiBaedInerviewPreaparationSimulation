...
class LanguageModelProcessor:
    def __init__(self):
        ...
        # system_prmopt = os.getenv("SYSTEM_PROMPT")
...
def play_stream(audio_stream, use_vlc=True):
    player = "ffplay" 
...
def send_tts_request(text):
    DEEPGRAM_URL = f"https://api.deepgram.com/v1/speak?model=aura-asteria-en&encoding=linear16&sample_rate=24000"    
    headers = {
...
def text_to_speech(text):
    try:
        ...
        audio_stream = send_tts_request(text)
...
class ConversationManager:
    ...
    async def main(self, audio_bytes):
        def handle_full_sentence(audio_bytes):
            self.transcription_response = audio_bytes
        ...
        while True:
            ...
            text_to_speech(llm_response)  # Call TTS function here
